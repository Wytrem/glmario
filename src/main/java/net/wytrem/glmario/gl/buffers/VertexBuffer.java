...
{
    private static final int VERTEX_BUFFER_GROW = 4096;
    private static final int INDICES_BUFFER_GROW = 1024;
    ...
    {
        vextexBuffer = BufferUtils.createByteBuffer(size);
        indicesBuffer = BufferUtils.createByteBuffer(size);
    ...
    public VertexBuffer textureId(int id)
    {
        vextexBuffer.put((byte) id);
        return this;
    }
    ...
    public static enum Mode
    {
        ...
        TRIANGLES_FAN(GL_TRIANGLE_FAN, false),
        TRIANGLES_STRIP(GL_TRIANGLE_STRIP, false),
